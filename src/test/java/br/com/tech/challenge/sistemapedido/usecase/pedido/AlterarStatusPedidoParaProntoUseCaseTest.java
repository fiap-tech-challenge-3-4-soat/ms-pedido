...
class AlterarStatusPedidoParaProntoUseCaseTest {
    @Mock
    private PedidoGateway gateway;
    @InjectMocks
    private AlterarStatusPedidoParaProntoUseCase underTest;
    @Test
    void deveriaAlterarStatusParaProntoComSucesso() {
    ...
    @Test
    void deveriaLancarExcecaoQuandoOPedidoNaoEstaComStatusEmPreparacao() {
        var pedido = TestObjects.getPedido();
        var idPedido = 1L;
