...
class AlterarStatusPedidoParaEmPreparacaoTest {
    @Mock
    private PedidoGateway gateway;
    @InjectMocks
    private AlterarStatusPedidoParaEmPreparacao underTest;

    @Test
    void deveriaAlterarStatusParaEmPreparacaoComSucesso() {
    ...
    @Test
    void deveriaLancarExcecaoQuandoOPedidoNaoEstaComStatusRecebido() {
        var pedido = TestObjects.getPedido();
        var idPedido = 1L;
